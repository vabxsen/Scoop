...
/** A deliberate type scale (no custom typeface bundled yet) so hierarchy stays consistent app-wide. */
val ScoopTypography =
    Typography(
        ...
        titleLarge = TextStyle(fontFamily = baseFont, fontWeight = FontWeight.SemiBold, fontSize = 20.sp, lineHeight = 26.sp),
